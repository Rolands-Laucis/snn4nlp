...
parser.add_argument('--model_output_dir', type=str, default='output_results/upos/', help='Output directory for saved model checkpoint')
...
run_filename_base = "_".join([now, f'e-{args.epochs}', f'ctx-{args.context_size}', str(round(test_acc * 100, 2))])
