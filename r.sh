...
python -u experiments/E1.py --input_mode "spatial" --epochs 50 --batch_size 8 --beta 0.95 --sim_steps 10 --encoding_method "poisson" --decoding_method "spike_count" --output_file_prefix "E1_poisson" --limit 70000
python -u experiments/E1.py --input_mode "temporal" --epochs 50 --batch_size 8 --beta 0.95 --sim_steps 20 --encoding_method "latency" --decoding_method "ttfs" --output_file_prefix "E1_ttfs_20" --limit 70000
