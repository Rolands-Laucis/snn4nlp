...
# python experiments/E1.py --input_mode "spatial" --epochs 50 --batch_size 16 --beta 0.95 --sim_steps 10 --encoding "poisson" --decoding "spike_count" --output_file_prefix "E1_poisson" 
# python experiments/E1.py --input_mode "temporal" --epochs 50 --batch_size 16 --beta 0.95 --sim_steps 10 --encoding "latency" --decoding "ttfs" --output_file_prefix "E1_ttfs_10" 
# python experiments/E1.py --input_mode "temporal" --epochs 50 --batch_size 16 --beta 0.95 --sim_steps 20 --encoding "latency" --decoding "ttfs" --output_file_prefix "E1_ttfs_20" 
